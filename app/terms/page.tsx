export default function TermsPage() {
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", maxWidth: 680, margin: '0 auto', padding: '60px 24px', fontSize: '14px', lineHeight: 1.8, color: '#333' }}>
      ...
      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>5. Buy-ins and Payments</h2>
      <p>pool'em facilitates optional buy-in pools between friends. pool'em does not collect, hold, or distribute any funds. All payments are made directly between pool members via third-party services such as Venmo. pool'em is not responsible for any disputes related to pool buy-ins or payouts.</p>

      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>6. User Conduct</h2>
      ...
      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>7. Disclaimers</h2>
      ...
      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>8. Limitation of Liability</h2>
      ...
      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>9. Changes to Terms</h2>
      <p>We may update these terms from time to time. Continued use of the Service after changes constitutes acceptance of the new terms.</p>

      <h2 style={{ fontSize: '16px', fontWeight: 700, marginTop: '32px', marginBottom: '8px' }}>10. Contact</h2>
