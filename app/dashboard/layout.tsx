    ...
    <div style={{minHeight: '100vh', background: 'var(--bg)'}}>
      <div style={{borderBottom: '1px solid var(--border)', background: 'white', padding: '0.75rem 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 50}}>
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: '0.75rem'}}>
          ...
          <Link href="/dashboard" style={{fontSize: '0.8rem', color: 'var(--text-dim)', maxWidth: 140, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', padding: '4px 0', minHeight: 44, display: 'flex', alignItems: 'center'}}>{displayName}</Link>
