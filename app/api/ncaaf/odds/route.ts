...
// Identical odds-extraction shape to app/api/nfl/odds/route.ts — same API product, same
// bet names (Over/Under, Asian Handicap, Home/Away), just a different tournament_id.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('NCAAF odds cron error:', err)
