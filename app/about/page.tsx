export default function AboutPage() {
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", maxWidth: 680, margin: '0 auto', padding: '60px 24px', fontSize: '14px', lineHeight: 1.8, color: '#333' }}>
      ...
      <p>pool'em is a platform for hosting private prediction pools — with your friends, family, or coworkers, not strangers. Set your own rules, invite your group with a private link, and follow along as picks score automatically once games kick off.</p>
